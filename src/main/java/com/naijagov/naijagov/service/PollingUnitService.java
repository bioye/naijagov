...
public class PollingUnitService{
    ...
    public Page<PollingUnit> getPollingUnits(Pageable page, Integer wardId) {
        return pollingUnitRepository.findByWardId(page, wardId);
    } 

    public Page<PollingUnit> getPollingUnits(Pageable page, Ward ward) {
        return pollingUnitRepository.findByWard(page, ward);
    } 
